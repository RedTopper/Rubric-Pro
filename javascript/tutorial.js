...
tutorial = [
	...
	//students
	["#js_accounts", "Next, we have the accounts tab.<br><br><br>You can add student accounts here. If another teacher in your school already uses Rubric Pro, we'll use their student accounts.", function() {
	...
	["#qualityname", "Qualities belong in the top row of your rubrics. They deturmine what grade a student can get on a criteria. Sometimes they have a name such as 'Not Included', 'Poor', 'Good', or 'Proficient'.<br><br>If you don't want to include a name, you can leave this blank.", function() {
...
function createTutorialBox() {
	...
	//append buttons
	lastTutorialBox.append("<img src='images/face.png' class='tutorialface' title='Red, the tutorial guide!'>");
	lastTutorialBox.append("<div class='tutorialpara'>(" + (tutorialIndex + 1) + ") " + tutorial[tutorialIndex][1] + "</div>");
