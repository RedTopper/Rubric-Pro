...
<div class="object subtitle">
	<h2>Really unbind <?php echo  htmlentities($student["FIRST_NAME"]) . " " . htmlentities($student["LAST_NAME"]); ?> from your account?</h2>
</div>
...
<a id="js_accounts_view_unbind_select" class="object warn white" href="#" data-studentnum="<?php echo $student["NUM"]; ?>">
	<div class="arrow"></div>
	<h3>Yes, unbind <?php echo  htmlentities($student["FIRST_NAME"]) . " " . htmlentities($student["LAST_NAME"]); ?></h3>
</a>